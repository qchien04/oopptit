...
//            for(Nhanvien i:arr){
//                if(i.ten.toLowerCase().contains(q.toLowerCase())){
...
//        int stt = Integer.parseInt(this.sohieu);
//        if(this.ma.compareTo("GD") == 0 && stt > 1) this.ma = "NV";
//        else if(this.ma.compareTo("TP") == 0 || this.ma.compareTo("PP") == 0){
//            if(stt > 3) this.ma = "NV";
//        }
//    }
//
